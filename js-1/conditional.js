/*En un archivo llamado conditionals.js 
Escribre una función calcularColor que recibe un número 
como argumento y retorna un string de acuerdo al número:
...
El problema es que la función tiene algunos errores y 
no está funcionando. Tu misión es corregirla para 
que funcione correctamente según lo anterior.*/
